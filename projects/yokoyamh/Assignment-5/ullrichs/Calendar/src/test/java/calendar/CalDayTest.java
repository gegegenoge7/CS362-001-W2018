...
public class CalDayTest 
{
	...
	public void test01()  throws Throwable  
	{
		...
		GregorianCalendar gregCal2 = new GregorianCalendar(3,2,1);
		CalDay calDay2 = new CalDay(gregCal2);
		//Construct a new Appointment object with the initial data
		Appt appt = new Appt(startHour, startMinute, startDay, startMonth, startYear, title, description);
		Appt appt2 = new Appt(23,1,1,2,3,"none","none");
			calDay.addAppt(appt);
			...
			String todayDate2 = 2 + "/" + 1 + "/" + 3;
			sb2.append("\t --- " + todayDate + " --- \n");
			sb2.append(" --- -------- Appointments ------------ --- \n");
			sb2.append("\n");
			assertEquals(sb2.toString(),calDay2.toString());
	}
